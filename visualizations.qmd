...
mypath = "datasets\LVJ_OPTO_2022_GE21122022\LVJ_OPTO_2022_GE21122022"
...
for f in fileBaseName:
  pys.PlotOscVoltCurr(path_to_dir=mypath, datasetBaseName=f, endings=fileEndings, title=f)

files_dataOneFile = [f for f in onlyfiles if f[-6]!='_' and f[-7]!='_']
for f in files_dataOneFile:
  pys.PlotSingleFile_OPHO(fileName=f, filePath=mypath, title=f, columnNames=('2','3','F1'))
```
